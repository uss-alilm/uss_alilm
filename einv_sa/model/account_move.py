...
class AccountMove(models.Model):
    ...
    einv_sa_qr_code_str = fields.Char(string='ZATCA QR Code', compute='_compute_eniv_qr_code_str')
...
class AccountMoveLine(models.Model):
    ...
    einv_amount_tax = fields.Monetary(string="Amount tax", compute="_compute_amount_tax", store=True)
