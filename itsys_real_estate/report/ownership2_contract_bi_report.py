...
class report_ownership2_contract_bi(models.Model):
    _name = "report.ownership2.contract.bi"
    _description = "ownership2 Contracts Statistics"
    _auto = False
    ...
    def init(self):
        tools.drop_view_if_exists(self._cr, 'report_ownership2_contract_bi')
        self._cr.execute("""
