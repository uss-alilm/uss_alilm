...
class owner2_account_check(models.TransientModel):
    _name = 'owner2.account.check'
    ...
    def create_owner2_invoice(self):
...
class owner2_expense(models.TransientModel):
    _name = 'owner2.expense'

    main_id= fields.Many2one('owner2.account.check', readonly=True)#,ondelete='cascade'
